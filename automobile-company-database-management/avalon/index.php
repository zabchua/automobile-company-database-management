               ...
               <div class="col-lg-9">
                  <div class="right_header_info">
                     <ul>
                        ...
                        <li><img style="margin-right: 0px;" src="images/mail_icon.png" alt="#" /><a href="#"> Guest </a></li>
            ...
            <div class="row">
               <div class="col-md-5">
                  <div class="full slider_cont_section">
                     <h4>The World's #1 Automobile Company</h4>
                     <h3>SZA Auto</h3>
                     <p>We’re building today for a safe, more sustainable tomorrow.</p>
                     <div class="button_section">
                        <a href="./login.php">Test Drive</a>
                     </div>
                  </div>
               </div>
               <div class="col-md-7">
         ...
         <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
               ...
               <div class="full button_section margin_top_30">
                    <a href="browsecar.php">See More</a>
                  </div>
            </div>
