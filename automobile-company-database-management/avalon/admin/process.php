...
<body>
    ...
    if (isset($_POST['save'])){
        ...
        $mysqli->query("INSERT INTO users (f_name, m_name, l_name, house_no, street, city, country, phone_no, email) VALUES('$fname', '$mname', '$lname', '$hn', '$st', '$city', '$country', '$pn', '$email')") or die($mysqli->error);
