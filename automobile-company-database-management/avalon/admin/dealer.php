...
<body>
    ...
    <li class="nav-item">
        <a class="nav-link active" href="#">Dealers</a>
    </li>
    <li class="nav-item">
    ...
    <?php require_once 'process_dealer.php'; ?>
    ...
    <h1 class="display-4">Dealer <small class="text-muted">Database Form</small></h1>
        <form action="process_dealer.php" method="POST">
            <input type="hidden" name="dealer_id" value="<?php echo $dealer_id; ?>">
            <div class="hstack gap-3">
            <div class="col form-group" style="padding-top: 1em">
                <label for="">First Name</label>
                <input type="text" name="fname" class="form-control" value="<?php echo $fname; ?>" placeholder="e.g. Juan Miguel" required autofocus>
            </div>
            <div class="col form-group" style="padding-top: 1em">
                <label for="">Middle Name</label>
                <input type="text" name="mname" class="form-control" value="<?php echo $mname; ?>" placeholder="e.g. Cirilo" required>
            </div>
            <div class="col form-group" style="padding-top: 1em">
                <label for="">Last Name</label>
                <input type="text" name="lname" class="form-control" value="<?php echo $lname; ?>" placeholder="e.g. Dela Cruz" required>
            </div>
            </div>
            <div class="hstack gap-2">
            <div class="col form-group" style="padding-top: 1em">
                <label for="">House No.</label>
                <input type="text" name="hn" class="form-control" value="<?php echo $hn; ?>" placeholder="e.g. 123" required>
            </div>
            <div class="col form-group" style="padding-top: 1em">
    ...
    <?php
        ...
        $result = $mysqli->query("SELECT * FROM dealer") or die(mysqli_error);
        //pre_r($result);
    ?>

    <div class="mx-auto" style="width: 99%; padding-top: 3em; padding-bottom: 5em;">
    <h1 class="display-4" style="padding-bottom: 0.3em;">Dealer <small class="text-muted">Information Table</small></h1>
        <table class="table">
            <thead>
                <tr>
                    <th>First Name</th>
        ...
        <?php
            while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="dealer.php?edit=<?php echo $row['dealer_id']; ?>"
                        ...
                        function check(e){
                            ...
                            if (result.isConfirmed) {
                                document.location.href = "process_dealer.php?delete=" + e;
                            } else if (
