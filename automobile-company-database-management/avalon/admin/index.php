...
<body>
    ...
    <h1 class="display-4">Customer <small class="text-muted">Database Form</small></h1>
    ...
    <?php
        ...
        $result = $mysqli->query("SELECT * FROM users WHERE role = 'customer'") or die(mysqli_error);
        //pre_r($result);
    ?>

    <div class="mx-auto" style="width: 99%; padding-top: 3em; padding-bottom: 5em;">
    <h1 class="display-4" style="padding-bottom: 0.3em;">Customer <small class="text-muted">Information Table</small></h1>
        <table class="table">
            <thead>
                <tr>
                    <th>First Name</th>
            ...
            while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button onclick="check(<?php echo $row['user_id']; ?>)" type="button" class="btn btn-danger">Delete</button>
