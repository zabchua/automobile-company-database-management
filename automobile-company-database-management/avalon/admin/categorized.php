...
<body>
    ...
    <li class="nav-item">
        <a class="nav-link active" href="./categorized.php">Categories</a>
    </li>
    </ul>

    <?php require_once 'process_categorized.php'; ?>
    ...
    <h1 class="display-4">Categories <small class="text-muted">Database Form</small></h1>
        <form action="process_categorized.php" method="POST">
            ...
            <div class="col form-group" style="padding-top: 1em">
                ...
                <input type="text" name="type_id" class="form-control" value="<?php echo $type_id; ?>" placeholder="e.g. 123" required autofocus pattern="^[0-9]*$">
            </div>
    ...
    <?php
        ...
        $result = $mysqli->query("SELECT * FROM categorized") or die(mysqli_error);
        //pre_r($result);
    ?>

    <div class="mx-auto" style="width: 99%; padding-top: 3em; padding-bottom: 5em;">
    <h1 class="display-4" style="padding-bottom: 0.3em;">Categories <small class="text-muted">Information Table</small></h1>
        <table class="table">
            <thead>
                <tr>
                    <th>Serial No.</th>
        ...
        <?php
            while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="categorized.php?edit=<?php echo $row['serial_no']; ?>"
                        ...
                        function check(e){
                            ...
                            if (result.isConfirmed) {
                                document.location.href = "process_categorized.php?delete=" + e;
                            } else if (
